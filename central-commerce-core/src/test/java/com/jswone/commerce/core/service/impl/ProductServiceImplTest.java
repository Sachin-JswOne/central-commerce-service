...
class ProductServiceImplTest {
    ...
    void getVariant_shouldMatchRangeBasedAttribute() {
        ...
        Pair<Boolean, List<Attribute>> result =
                ProductServiceImpl.checkForRangeBasedMatch(
    ...
    void isMatchProductVariant_shouldReturnTrue_whenExactMatch() {
        ...
        Pair<Boolean, List<Attribute>> result =
                ProductServiceImpl.isMatchProductVariant(
                        variant,
    ...
    void isMatchProductVariant_shouldReturnFalse_whenVariantIsNull() {
        Pair<Boolean, List<Attribute>> result =
                ProductServiceImpl.isMatchProductVariant(null, List.of());
    ...
    void isMatchProductVariant_shouldReturnTrue_whenAttributesEmpty() {
        ...
        Pair<Boolean, List<Attribute>> result =
                ProductServiceImpl.isMatchProductVariant(variant, List.of());
    ...
    void getProductFromSlug_shouldReturnProductSlug_whenValidResponse() {
        ...
        Map<String, ProductTypeData> productTypeMap =
                Map.of(productTypeId, productTypeData);
        ...
        ProductTypeBulkResponse typeBulkResponse =
                new ProductTypeBulkResponse(200, "SUCCESS", bulkDTO);

        ProductSlug mappedSlug = new ProductSlug();

        when(centralCatalogueClient.getProductFromSlug(slug, "msme"))
