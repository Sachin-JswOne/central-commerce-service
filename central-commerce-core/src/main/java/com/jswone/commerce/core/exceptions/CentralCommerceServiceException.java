...
public class CentralCommerceServiceException extends RuntimeException {
    ...
    public CentralCommerceServiceException(String message, Throwable throwable, HttpStatus httpStatus) {
        super(message, throwable);
        this.httpStatus = httpStatus;
    }

    public CentralCommerceServiceException(String message, HttpStatus httpStatus, Throwable throwable) {
        super(message, throwable);
        this.httpStatus = httpStatus;
    }
