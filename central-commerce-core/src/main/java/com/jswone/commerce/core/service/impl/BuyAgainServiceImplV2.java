...
@Slf4j
@Service
public class BuyAgainServiceImplV2 implements BuyAgainServiceV2 {
    ...
    public Cache getBuyAgainCache() {
        ...
        if (cache == null) {
            log.error("Buy_Again - Cache '{}' not found in CacheConfig", CacheNames.BUY_AGAIN_PRODUCTS_CACHE_PREFIX_V2);
            throw new IllegalStateException("Cache not configured: " + CacheNames.BUY_AGAIN_PRODUCTS_CACHE_PREFIX_V2);
        }
        return cache;
    }
}
